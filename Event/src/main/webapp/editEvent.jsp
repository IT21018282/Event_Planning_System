...
<center><h1 style='color:white;margin:2px;'>Edit Event Form</h1></center>
<hr>
<a href="Eventlist.jsp" class="Back">Back to Event List</a>
<%
...
<form class="eventform" action="editEvent" method="post">
	       <input type="hidden" name="eventId"value="<%= rs.getString("id")%>">
		  <table class="formtbl">
		  <tr>
		  <td><label>Event Type</label></td>
		  <td>
			<select name="eventType" class="box"  required>
		  ...
		  <td colspan="2"><input type="text" name="eventDescription"  placeholder="Eneter the event description" class="box1" value="<%= rs.getString("description")%>"></td>
		  </tr>
		  <tr >
		  <tr>
		  <td><label>Services Provide</label></td>
		  <td ><textarea name="services"   placeholder="Enter the service provide" rows="13" cols="60" class="box1" ><%= rs.getString("services")%></textarea></td>
		  </tr>
		  <tr >
		  <td colspan="2"><center><input type="submit" value="Edit Now"  class="btn" name="sub">
		  <a href='editEvent.jsp?id=<%= rs.getString("id")%>' class="btn">Cancel</a></td>
		  </tr>
		  </table>
		 <% 	}
	 	connect.close();	}
